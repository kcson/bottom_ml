...
class DeepConvNet:
    def __init__(self, input_dim=(1, 28, 28),
        ...
        for idx, conv_param in enumerate([conv_param1, conv_param2, conv_param3, conv_param4, conv_param5, conv_param6]):
            self.params['W' + str(idx + 1)] = weight_init_scales[idx] * np.random.randn(conv_param['filter_num'], pre_channel_num, conv_param['filter_size'],
    ...
    def gradient(self, x, t):
        ...
        temp_layer = self.layers.copy()
        temp_layer.reverse()
        for layer in temp_layer:
